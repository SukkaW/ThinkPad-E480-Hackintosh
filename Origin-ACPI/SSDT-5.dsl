 ...
 *
 * Disassembly of SSDT-5.aml, Sun Jun 21 18:40:05 2020
 *
            ...
            Device (CR01)
            {
                ...
                Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
                {
                    If (LEqual (USTC, One))
                    {
                        ...
                        Store (\PLDU, PLDP) /* \_SB_.UBTC.CR01._PLD.PLDP */
                        Return (PLDP) /* \_SB_.UBTC.CR01._PLD.PLDP */
                    }
                }
            }
            ...
            If (LEqual (UTCM, One))
            {
                Device (CR02)
                {
                    ...
                    Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        {
                            Name (PLDP, Buffer (0x10){})
                            Store (\PLDU, PLDP) /* \_SB_.UBTC.CR02._PLD.PLDP */
                            Return (PLDP) /* \_SB_.UBTC.CR02._PLD.PLDP */
                        }
                    }
                }
            }
